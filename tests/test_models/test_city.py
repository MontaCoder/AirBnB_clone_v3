...
class TestCityDocs(unittest.TestCase):
    ...
    def test_city_class_docstring(self):
        ...
        city_doc = City.__doc__
        self.assertIsNot(city_doc, None, "City class needs a docstring")
        self.assertTrue(
            (isinstance(City.__doc__, str) and len(City.__doc__) >= 1),
    ...
    def test_city_func_docstrings(self):
        ...
        for func in self.city_f:
            fu = func[1]
            self.assertIsNot(fu.__doc__, None, "{:s}docstring".format(func[0]))
            self.assertTrue(
                (isinstance(fu.__doc__, str) and len(fu.__doc__) >= 1),
